...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 249.99,
    description: 'Fitness tracking, heart-rate monitoring, and GPS in a sleek aluminum case.',
  ...
  },
  {
    ...
    price: 24.99,
    description: 'Soft, breathable crew-neck tee made from 100% organic cotton.',
  ...
  },
  {
    ...
    price: 59.99,
    description: 'Classic five-pocket jeans with a modern slim fit and stretch denim.',
  ...
  },
  {
    ...
    price: 19.99,
    description: 'Insulated 32 oz bottle keeps drinks cold for 24 hours or hot for 12 hours.',
  ...
  },
  {
    ...
    price: 34.99,
    description: 'Set of four handcrafted mugs with a matte glaze finish, dishwasher safe.',
  ...
  },
  {
    ...
    name: 'LED Desk Lamp',
    price: 44.99,
    description: 'Adjustable arm lamp with three color temperatures and USB charging port.',
  ...
  },
  {
    ...
    name: 'Running Shoes',
    price: 89.99,
    description: 'Lightweight mesh upper with responsive cushioning for daily runs.',
  ...
  },
  {
    ...
    price: 129.99,
    description: 'Genuine leather bag with adjustable strap and multiple interior pockets.',
  ...
  },
  {
    ...
    name: 'Yoga Mat',
    price: 29.99,
    description: 'Non-slip 6mm mat with carrying strap, ideal for yoga and pilates.',
  ...
  },
  {
    ...
    price: 99.99,
    description: 'Durable hiking pack with rain cover, hydration sleeve, and hip belt.',
  ...
  },
  {
    ...
    price: 39.99,
    description: 'A comprehensive guide to software design patterns and best practices.',
  ...
  },
  {
    ...
    price: 44.99,
    description: 'Hands-on introduction to building scalable web applications with TypeScript.',
  ...
  },
  {
    ...
    price: 119.99,
    description: 'RGB backlit keyboard with Cherry MX switches and aluminum frame.',
  ...
  },
  {
    ...
    price: 27.99,
    description: 'Set of three soy wax candles in lavender, vanilla, and eucalyptus scents.',
...
export class ProductDataService {
  ...
  getById(id: string): Observable<Product | undefined> {
    return of(PRODUCTS.find((p) => p.id === id)).pipe(delay(300));
  }
}